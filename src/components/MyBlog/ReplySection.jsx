            ...
            <div key={reply.id} className="p-4 bg-gray-100 rounded-lg">
              ...
              <div className="flex items-center mt-2 space-x-4">
                <button
                  type="button"
                  className="flex items-center text-sm text-gray-500 hover:underline font-medium"
                  onClick={() => handleLikeDislike(comment.id, reply.id, "like")}
                >
                  <img src="like.png" className="w-4 h-4 mr-2"/> {reply.likes}
                </button>
                <button
                  type="button"
                  className="flex items-center text-sm text-gray-500 hover:underline font-medium"
                  onClick={() => handleLikeDislike(comment.id, reply.id, "dislike")}
                >
                  <img src="dislike.png" className="w-4 h-4 mr-2"/> {reply.dislikes}
                </button>
              </div>
            </div>
          ))}
